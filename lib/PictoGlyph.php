...
class PictoGlyph extends Identicon implements IdenticonIface
{
    ...
    protected function simpleBear(int $x, int $y): void
    {
        ...
        //$spath .= 'c-5,-5.357142857 -10,-1.5 -12.5 ';
        //$spath .= 'c-5,3 -9.25,6.25 -11.25,10.5 ';
        
        /*    
c -16,-24 -24,-32           -45,     -8
c -12,14.4 -28,15           -45,      0
c -15,-17 -34,-36           -48,    -51
c -20,-21.428571429 -40,-6  -50,      0
  c -20,12 -37,25             -45,     42
        */
        $this->svgStrokePath(($x - 50), ($y + 51), $spath, $this->foregroundRgb, 1);
