...
class PictoGlyph extends Identicon implements IdenticonIface
{
    ...
    protected function simpleBear(int $x, int $y): void
    {
        ...
        $spath .= 'c-0.75,-4 -2,-10 -3.75,-20 ';
        $spath .= 'c-0.75,-10 2,-22.5 6.25,-29.5 ';
        
        /*        
c -24,25 -50,67 -60,85
c -10,18 -35,80 -14 150
c 4.5,15 15,13 27,13
c 10,0 28,-10 33,-14
...
c 8,-10 3,-20 0,-36
  ...
  c -3,-40 8,-90 25,-118
        ...
        */
        ...
        $this->svgStrokePath(($x - 42.75), ($y - 64.25), $spath, $this->foregroundRgb, 1);
