...
class PictoGlyph extends Identicon implements IdenticonIface
{
    ...
    protected function simpleBear(int $x, int $y): void
    {
        ...
        $spath .= 'c4,11.25 -2.75,27.5 2.5,32 ';
        $spath .= 'c3.5,3 5.25,4 8,4 ';
        $spath .= 'a22.5,22.5 0 0 0 8,-4.25 ';
        $spath .= '-3.75,-12.5 -6,-22.5 -6,-29.5 ';
        $spath .= 'c0,-10 6.25,-25 8.75,-26.75 ';
        
        /*        
c -19,10 -32,15 -45,30
c -20,23.076923077 -32,50 -40,68
c -20,45 -11,110 10,128
c 14,12 21,16 32,16
a 90,90 0 0 0 32,-17
c -15,-50 -24,-90 -24,-118
  
  c 0,-40 25,-100 35,-107
        */
        

        $this->svgStrokePath(($x + 10.5), ($y - 78.5), $spath, $this->foregroundRgb, 1);
